...
Currently only Meson is supported for running Unit tests and should be the build system chosen. There is a backwards
Makefile target for test but that still calls Meson.
...
# Documentation
Supported under Doxygen with proper commenting docs can be generated to support the code.

Docs are automatically generated by Doxygen under the Meson target. Open under Firefox/Chrome directory the target 'build/doc/html/index.html'
